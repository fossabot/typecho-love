        ...
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            ...
            <?php
                                    ...
                                    try {
                                        ...
                                        /** 初始评论 */
                                        $installDb->query($installDb->insert('table.comments')->rows(array('cid' => 1, 'created' => Typecho_Date::time(), 'author' => 'Typecho Lover', 'ownerId' => 1, 'url' => 'https://typecho.love',
                                        'ip' => '127.0.0.1', 'agent' => $options->generator, 'text' => '欢迎加入 Typecho Lover', 'type' => 'comment', 'status' => 'approved', 'parent' => 0)));
                                        ...
                                        'url' => 'https://typecho.love', 'screenName' => $config['userName'], 'group' => 'administrator', 'created' => Typecho_Date::time())));
