...
class Widget_Options_Discussion extends Widget_Abstract_Options implements Widget_Interface_Do
{
    ...
    public function form()
    {
        ...
        $commentsShowOptions = array(
            ...
            'commentsUrlNofollow'   =>  _t('对评论者个人主页链接使用 <a href="http://zh.wikipedia.org/wiki/Nofollow">nofollow 属性</a>'),
            'commentsAvatar'        =>  _t('启用 <a href="https://zh.gravatar.com">Gravatar</a> 头像服务, 最高显示评级为 %s 的头像',
